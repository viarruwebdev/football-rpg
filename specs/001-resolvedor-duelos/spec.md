...
- **P: ¿Qué distribución tiene la incertidumbre?** R: Triangular centrada en 0. Banda dinámica según diferencia efectiva (0-4→±10, 5-6→±11, 7+→±12; recalibrada en [ADR-0001](./adr/0001-recalibrar-banda-dinamica.md) tras corregir un bug de `sampleTriangular` que colapsaba la triangular a una distribución degenerada). Composure ajusta (15-17→−1, 18-20→−2, <8→+1). **Suelo mínimo ±3.**
