...
**Tarea de mantenimiento de contenido (resuelta — issue #2):** la carta **T06 (Disparo lejano)** del catálogo describía "Long Shots 16+ reduce penalización en 2" pero omitía el escalón "18+ elimina" que sí figura en el manual §6 (fuente de verdad). Corregido en la entrada de T06 del catálogo de diseño (`doc/Football RPG/CATÁLOGO COMPLETO DE CARTAS…`), añadiendo el escalón 18+ y la nota de que la extensión del alivio al -5 de Medio es decisión de balance de la 002. No se toca `packages/content` (aún vacío): cuando se pueble en su feature, T06 nacerá alineada.
